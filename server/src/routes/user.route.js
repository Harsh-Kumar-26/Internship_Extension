...
import { applyforinter,singleuserintern,allbookmarked_internships,allapplied_internships,logoutuser, removefromintern, bookmarked_internships, remove_bookmarked_internship, allinternswithseats } from "../controllers/user.controller.js";
...
userroute.route("/removefromintern").post(verifyJWTuser,removefromintern);//doubt
...
userroute.route("/getallintern").get(verifyJWTuser,allinternswithseats);
